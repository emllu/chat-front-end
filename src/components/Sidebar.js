...
// import { NavLink, useNavigate } from 'react-router-dom';
// import { BiLogOut } from "react-icons/bi";
// import Avatar from '../pages/avatar'; // Ensure correct case and path
// import { useDispatch, useSelector } from 'react-redux';
// import EditUserDetails from './EditUserDetail'; // Ensure correct case and path
// import { FiArrowUpLeft } from "react-icons/fi";
// import SearchUser from '../pages/SearchUser'; // Ensure correct case and path
// import Loading from './Loading'; // Ensure correct case and path
// import { logout } from '../redux/userSlice';
...
//     return (
//         <div className='w-full h-full grid grid-cols-[48px,1fr] bg-white border '>
//             <div className='bg-slate-100 w-12 h-full rounded-tr-lg rounded-br-lg py-5 text-slate-600 flex flex-col justify-between'>
//                 <div>
//                     {/* <NavLink 
//                         to="/chat"
...
//                                 </div>
//                                 <p className='text-lg text-center text-slate-400'>Explore User to Start Chat</p>
//                             </div>
//                         )
//                     }
//                 </div>
